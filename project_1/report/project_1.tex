...
\subsection{The Franke function}
    ...
    \begin{figure}
        ...
        \caption{Mean size of the 94\% confidence interval across all the predictors for polynomials up to the $5^{\textup{th}}$ order with OLS for $N=500$ random samples of the Franke Function. Where the dashed line indicates $2^\textup{nd}$ order polynomial regression of the points}
    \end{figure}
...
%% Later parts, connect Explosion at ~/10-/20 predictors to existing literature (Harrell)
