...
\subsection{The terrain data}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=\columnwidth]{TERRAIN_bootstrap_best_LASSO_Ridge.pdf}\label{<figure2>}
        \caption{}
    \end{figure}
    ...
    \begin{figure*}
         \centering
         \subfloat[][Ridge regression]{
            \includegraphics[width=\columnwidth]{RIDGE_CV_Terrain_contour.pdf}\label{<figure1>}
         }
         \subfloat[][LASSO regression]{
            \includegraphics[width=\columnwidth]{LASSO_CV_Terrain_contour.pdf}\label{<figure2>}
         }
         \caption{$\log_{10}(\textup{MSE})$ for $k=5$ crossvalidated Rige \& LASSO regression performed on the terrrain data}
         \label{contour plots}
    \end{figure*}
