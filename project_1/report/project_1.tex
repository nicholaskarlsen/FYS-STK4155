...
The terrain data, on the other hand, is a collection of measured elevation heights as a function of x- and y-coordinates, which has been downloaded from \cite{4155_repo}.
...
\subsection{The Franke function}
    ...
    \begin{figure*}
         ...
         \caption{$\log_{10}(\textup{MSE})$ for $k=5$ crossvalidated Rige \& LASSO regression performed on $n=100$ samples of the Franke Function with added random noise in the form $0.2 * \mathcal N(0, 1)$}
         \label{contour plots}
    \end{figure*}
