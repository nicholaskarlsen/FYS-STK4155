...
def part_1a():
    ...
    beta = OLS.OLS_2D(x, y, z, n=3)

    # Check MSE
    print("MSE = %.3f" % MSE(FrankeFunction(x, y), linear_regression.evaluate_poly_2D(x, y, beta)))
    ...
    z_fit = linear_regression.evaluate_poly_2D(X, Y, beta)
