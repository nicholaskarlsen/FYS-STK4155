...
\begin{figure*}
     ...
     \caption{MSE for $k=5$ cross-validated Ridge \& LASSO regression performed on $N=500$ samples of the Franke Function with added random noise in the form $\mathcal N(0, 0.2)$}
